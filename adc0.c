...
void initAdc0Ss1()
{
    ...
    ADC0_SSMUX0_R = 0;                           // Set analog input for mic 3, PORTE,3 at AIN0
    ADC0_SSMUX1_R = 1;                           // Set analog input for mic 2, PORTE,2 at AIN1
    ADC0_SSMUX2_R = 2;                           // Set analog input for mic 1, PORTE,1 at AIN2
...
int16_t readAdc0Ss1(uint8_t mic)
{
    ...
    switch(mic){
    case 1:
        sample =  ADC0_SSFIFO2_R;                           // get single result from the FIFO
        break;
    case 2:
        sample =  ADC0_SSFIFO1_R;
        break;
    case 3:
        sample =  ADC0_SSFIFO0_R;
        break;
    case 4:
